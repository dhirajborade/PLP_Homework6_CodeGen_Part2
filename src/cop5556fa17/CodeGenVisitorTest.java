...
public class CodeGenVisitorTest implements ImageResources {
	...
	/**
	 * Blocks program until a key is pressed to the console. May be useful during
	 * development to delay closing frames displaying images
	 */
	...
	@Test
	/**
	 * The program in our language creates and displays a 512 x 512 image with all
	 * red pixels. Then it compares that to an image created by
	 ...
	 * updated to reflect the new instructions for where to put log statements in
	 * assignment 6.
	 *
	 * @throws Exception
	 */
	...
	public void prog3() throws Exception {
		...
		String input = prog + " boolean g;\n" + "g <- @ 0;\n" + "g -> SCREEN;\n" + "int h;\n" + "h <- @ 1;\n"
				+ "h -> SCREEN;";
		byte[] bytecode = genCode(input);
		String[] commandLineArgs = { "true", "55" }; // create command line argument array to initialize params, none in
														// this case
		runCode(prog, bytecode, commandLineArgs);
	...
	public void prog4() throws Exception {
		...
		show(input);
		byte[] bytecode = genCode(input);
		String[] commandLineArgs = { "true", "34", "56" }; // create command line argument array to initialize params,
															// none in this case
		runCode(prog, bytecode, commandLineArgs);
	...
	@Test
	// reads an image from the filename passed as command line argument and displays
	// it.
	// Compares the image output (and logged) from our language and compares with
	// the same image read directly from the file.
